    ...
    inline const std::map<std::string, BrowserConfig> GetConfigs() {
        ...
        return {
            ...
            {"brave", {"Brave", L"brave.exe",
                ...
                {0xF396861E, 0x0C8E, 0x4C71, {0x82, 0x56, 0x2F, 0xAE, 0x6D, 0x75, 0x9C, 0xE9}},  // IElevatorBrave (v1)
            ...
            {"avast", {"Avast", L"AvastBrowser.exe",
                ...
                {0x7737BB9F, 0xBAC1, 0x4C71, {0xA6, 0x96, 0x7C, 0x82, 0xD7, 0x99, 0x4B, 0x6F}},  // IElevatorChrome IID (Avast)
