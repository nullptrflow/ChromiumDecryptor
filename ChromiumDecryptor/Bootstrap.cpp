...
namespace {
    ...
    constexpr DWORD H_VIRTUALPROTECT= hash("VirtualProtect");
    ...
    constexpr DWORD H_ZwAllocateVirtualMemory = 0x54B3D07F;
    constexpr DWORD H_ZwProtectVirtualMemory = 0x50E92888;
